...
const WebHero = () => {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[#0d1117]">
      ...
      {/* Name in top left - GitHub style */}
      {/* <div className="absolute top-8 left-8 z-20">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 bg-gradient-to-r from-[#4E9C7E] to-[#1f6feb] rounded-lg flex items-center justify-center">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        <div className="animate-fade-in">
          ...
          <div className="font-mono text-sm text-[#7d8590] mb-8 flex items-center justify-center gap-2">
            <span className="text-[#4E9C7E]">~</span>
            <span>$ cat introduction.txt</span>
          </div>

          {/* Main heading */}
          <h1 className="text-5xl md:text-7xl font-bold mb-6 text-white font-mono tracking-tight">
            Hello World,
            <br />
          ...
          <div className="flex items-center justify-center gap-2 mb-8">
            <span className="text-xl md:text-2xl text-[#7d8590] font-mono">
              &gt;{" "}
          ...
          {/* Description */}
          <p className="text-lg md:text-xl text-[#7d8590] mb-12 max-w-2xl mx-auto leading-relaxed font-mono">
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-12">
            {['TypeScript', 'React', 'Node.js', 'Python', 'Next.js', 'MongoDB', 'PHP', 'SQL', 'Java'].map((tech) => (
              <span
                key={tech}
                className="px-3 py-1.5 bg-[#161b22] border border-[#30363d] text-[#7d8590] text-sm font-mono rounded-md hover:border-[#4E9C7E] hover:text-white transition-all cursor-default"
              >
                {tech}
              </span>
            ))}
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button
              ...
              size="lg"
              className="bg-[#4E9C7E] hover:bg-[#5FBB97] text-black font-mono px-8 py-6 text-lg border border-[#4E9C7E] hover:scale-105 transition-all duration-300 shadow-lg"
            >
            ...
            <Button
              variant="outline"
              size="lg"
              className="bg-transparent border-[#30363d] text-[#7d8590] hover:text-white hover:border-white hover:bg-[#161b22] font-mono px-8 py-6 text-lg transition-all duration-300"
          ...
          {/* Stats bar */}
          <div className="mt-16 flex flex-wrap justify-center gap-8 text-[#7d8590] text-sm font-mono">
            <div className="text-center">
              <div className="text-white text-lg font-semibold">80+</div>
              <div>Projects</div>
            </div>
            <div className="text-center">
      ...
      {/* Scroll indicator */}
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-[#7d8590] animate-bounce">
